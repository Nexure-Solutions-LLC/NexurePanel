        ...
        <div class="container nexure-container">
            <div style="display:flex; align-items:top;">
                ...
                <div class="centered-content">
                    ...
                    <p class="font-14px margin-top-20px width-60 centered-content"><?php echo $VariableDefinitionHandler->organizationShortName; ?> has additional fees that may be incurred on your account. We advise all customers to look at the fee disclosures before they finish opening the account.</p>
                    <iframe src="<?php echo $VariableDefinitionHandler->feeDisclosureLink; ?>" class="margin-top-50px" style="height:800px; width:80%; border:0; outline:0;"></iframe>
                </div>
            </div>
        </div>
    </section>
